...
var fhir_types_1 = require("./fhir.types");
...
var FHIRfetch = function (params, parse) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _defaultHeaders = __assign(__assign({ "Content-Type": 'application/json' }, (params.authType === "bearer") && { "Authorization": "Bearer ".concat((0, fhir_types_1.isBasicAuth)(params.auth)) }), (params.authType === "basicAuth") && { "Authorization": "Basic ".concat((0, fhir_types_1.isBearer)(params.auth)) });
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.fetchParams = __assign(__assign({}, this.fetchParams), { url: "".concat(this.baseUrl, "/").concat(resource, "/").concat(id), method: 'GET' });
                        _a = this;
